...
public class Ball {
    ...
    /**
     * Getter method for the colour as a string
     *
     * @return the colour of the ball as a string
     */
    ...
    /**
     * Getter method for the PocketStrategy of the ball
     *
     * @return the PocketStrategy of the ball
     */
